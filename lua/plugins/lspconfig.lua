    ...
    'VonHeikemen/lsp-zero.nvim',
        ...
        config = function()
            ...
            lsp_zero.on_attach(function(client, bufnr)
                ...
                vim.keymap.set('n', 'K', vim.lsp.buf.hover, opts)                                         -- <space>h显示提示文档
                ...
                vim.keymap.set('n', '<leader>re', vim.lsp.buf.rename, opts)                                       -- <space>rn变量重命名
                -- vim.keymap.set({ 'n', 'x' }, '<leader>f', function() vim.lsp.buf.format({ async = true }) end, opts) -- <space>f进行代码格式化
                vim.keymap.set('n', '<leader>ca', vim.lsp.buf.code_action, opts)                                  -- <space>aw可以在出现警告或错误的地方打开建议的修复方法
                vim.keymap.set('n', '<leader>e', vim.diagnostic.open_float, opts)                                 -- <space>d浮动窗口显示所在行警告或错误信息
